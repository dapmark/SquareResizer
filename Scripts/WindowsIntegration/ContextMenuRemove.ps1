# SquareResizer context menu remover
...
if ($IsRussian) {
    $SuccessText = "Пункт контекстного меню удалён"
    $NothingText = "Пункт контекстного меню уже отсутствует"
    $ErrorText = "Ошибка"
    $LogText = "Лог:"
    $ClosingText = "Закрытие через {0}..."
}
else {
    $SuccessText = "Context menu item was removed"
    $NothingText = "Context menu item is already absent"
    $ErrorText = "Error"
    $LogText = "Log:"
